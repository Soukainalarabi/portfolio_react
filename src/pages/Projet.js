...
import rapport from "../assets/rapport-optimisation.pdf"
      ...
      <div>
        ...
        <div className="container-form">
          ...
          <section className="comparaison">
            ...
            <a className="btn btn-outline" href={rapport} rel="preload noreferrer" alt="rapport d'optimisation de la chouette agence" target="_blank" download="" >Rapport d'optimisation</a>
          </section>
          ...
          <section className="projetGit">
            ...
            <p className="text-start">Pour l'ensemble de ce projet j'ai utilisé le logiciel de versionning Git. Les
              ...
              comparer <Link rel="preload" to="https://soukainalarabi.github.io/soukainalarabi_4_20210916_start/"
                style={{ color: "#f3976c" }}>le site
                avant optimisation </Link> et <Link rel="preload" to="https://soukainalarabi.github.io/projet4/"
                  style={{ color: "#f3976c" }}>le site après
                optimisation </Link> Retrouvez le code source des deux étapes de ce projet sur mon espace
              GitHub :

              <Link to="https://github.com/Soukainalarabi/soukainalarabi_4_20210916_start" rel="preload"
                style={{ color: "#f3976c" }}></Link>

            </p>
            <ul className="text-start">
              <li> <Link rel="preload" to="https://github.com/Soukainalarabi/soukainalarabi_4_20210916_start"
                style={{ color: "#f3976c" }}>Code existant,
                avant les optimisations</Link></li>
              <li><Link rel="preload" to="https://github.com/Soukainalarabi/projet4" style={{ color: "#f3976c" }}>Code aprés les
                optimisations
                apportées</Link> </li>
